...
exports.defaults = exports.columns_default = void 0;
/**
...
const defaults = {
  ...
  ajax: true,
  // se true usa `ajaxUrl` e ignora `data`
  ajaxUrl: null,
  // url ajax
  data: [],
  // dati (per versione statica)
  footerData: [],
  caption: null,
  addRowIndex: false,
...
const columns_default = {
  ...
  parse: null,
  // funzione ad hoc per elaborare il valore
  rowHeading: false // se true, viene creato un elemento th[scope=row] invece di un td
};
exports.columns_default = columns_default;